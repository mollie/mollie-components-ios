    ...
    /// UIKit bridge for `MollieAppearance.ColorValue`. The theme stores
    ...
    /// for that addition.
    package extension MollieAppearance.ColorValue {
        var uiColor: UIColor {
    ...
    /// view hierarchy.
    package enum MollieAppearanceApplier {
        @MainActor
        package static func apply(
            _ theme: MollieAppearance,
